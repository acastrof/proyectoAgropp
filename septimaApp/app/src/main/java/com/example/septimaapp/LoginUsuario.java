...
public class LoginUsuario extends AppCompatActivity {
    ...
    public void metodoRegitro(View view) {
        Intent AFR=new Intent(this,RegistroUsuarios.class);
        startActivity(AFR);

    }
    public void atrial2activity(View view) {
        String usua = E1.getText().toString();
        String pass = E2.getText().toString();
        Cursor res = BD.getData(usua);
        String DATOS = null;
        if (res.moveToFirst()) {
            DATOS = "" + res.getString(5);
            if (res.moveToFirst()) {
            ...
            T1.setText(R.string.msj10);
            Toast toast = Toast.makeText(this, "", Toast.LENGTH_LONG);
            toast.setText(R.string.msj10);
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();
        }
